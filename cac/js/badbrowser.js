    ...
    function(module, exports, __webpack_require__) {
        ...
        BadBrowser = function() {
            function BadBrowser() {
                ...
                if (_classCallCheck(this, BadBrowser), this._userAgent = userAgent || navigator.userAgent, this._bowser = _bowser2.
            default, this.detectedBrowser = _bowser2.
            default._detect(this._userAgent), this.settings = extend({
                    template: null,
                    path: !1,
                    fullscreen: !0,
                    ignoreChoice: !1,
                ...
                },
                {
                    ...
                    logo: logo,
                    path: path
                }), this.settings.unsupported) for (var key in this.settings.unsupported)"string" == typeof this.settings.unsupported[key] || "number" == typeof this.settings.unsupported[key] ? this.settings.supported[key] = (parseInt(this.settings.unsupported[key]) + 1).toString() : this.settings.supported[key] = !this.settings.unsupported[key];
                this.check() || (this.settings.path ? ("function" == typeof this.settings.path ? path = this.settings.path() : "string" == typeof this.settings.path && (path = this.settings.path), this.getTemplate(path,
                function(text) {
                    _this2.settings.template = text || _this2.defaultTemplate,
                    _this2.toggleWarning()
            ...
            return _createClass(BadBrowser, [{
                ...
                value: function() {
                    ...
                    var isSupported = !1;
                    try {
                        var bowserMinVersions = _defineProperty({},
                        this.currentFlag.replace("_mobile", ""), this.minSupportVersion);
            ...
            },
            {
                ...
                value: function(element) {
                    ...
                    browserEl && (browserEl.innerHTML = this.name + " " + this.version)
                }
            },
            {
                key: "getCookie",
            ...
            },
            {
                ...
                get: function() {
                    ...
                    this.currentFlag, this.settings.supported[this.currentFlag])
                }
            }], [{
                key: "init",
    ...
    function(module, exports, __webpack_require__) { !
        ...
        function() {
            function detect(ua) {
                ...
                /\((mobile|tablet);[^\)]*rv:[\d\.]+\)/i.test(ua) && (result.firefoxos = t, result.osname = "Firefox OS")) : silk ? result = {
                    name: "Amazon Silk",
                    silk: t,
                ...
                return tablet || nexusTablet || "ipad" == iosdevice || android && (3 == osMajorVersion || osMajorVersion >= 4 && !mobile) || result.silk ? result.tablet = t: (mobile || "iphone" == iosdevice || "ipod" == iosdevice || android || nexusMobile || result.blackberry || result.webos || result.bada) && (result.mobile = t),
                result.msedge || result.msie && result.version >= 10 || result.yandexbrowser && result.version >= 15 || result.vivaldi && result.version >= 1 || result.chrome && result.version >= 20 || result.samsungBrowser && result.version >= 4 || result.firefox && result.version >= 20 || result.safari && result.version >= 6 || result.opera && result.version >= 10 || result.ios && result.osversion && result.osversion.split(".")[0] >= 6 || result.blackberry && result.version >= 10.1 || result.chromium && result.version >= 20 ? result.a = t: result.msie && result.version < 10 || result.chrome && result.version < 20 || result.firefox && result.version < 20 || result.safari && result.version < 6 || result.opera && result.version < 10 || result.ios && result.osversion && result.osversion.split(".")[0] < 6 || result.chromium && result.version < 20 ? result.c = t: result.x = t,
                result
            }
            ...
            function compareVersions(versions) {
                for (var precision = Math.max(getVersionPrecision(versions[0]), getVersionPrecision(versions[1])), chunks = map(versions,
                function(version) {
                    var delta = precision - getVersionPrecision(version);
                    return version += new Array(delta + 1).join(".0"),
                    map(version.split("."),
                    function(chunk) {
            ...
            function isUnsupportedBrowser(minVersions, strictMode, ua) {
                ...
                for (var browser in minVersions) if (minVersions.hasOwnProperty(browser) && _bowser[browser]) {
